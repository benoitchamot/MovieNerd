...
def home():
	...
	return (
		...
		f"</ul>"
		f"<p><a href='api/v1.0/financials'>/api/v1.0/financials</a></p>"
		f"<ul>"
		f"	<li>Returns title, budget, revenue and ROI for all movies</li>"
		f"</ul>"
		...
		f"	<li>Example link is given for genre = Action and actor = Tom Cruise</li>"
		f"</ul>"
		...
		f"	<li>Example link is given for genre = Action</li>"
		f"</ul>"
		f"<p><a href='api/v1.0/actors_ratings/1'>/api/v1.0/actors_ratings/&#x003C;nan&#x003E;</a></p>"
		f"<ul>"
		f"	<li>Returns average IMDB rating and networth for all actors</li>"
		f"	<li>May include NaN in net worth if nan = 1 (more rows)</li>"
		f"	<li>Remove rows with NaN in net worth if nan = 0 (fewer rows)</li>"
		f"	<li>Example link is given for nan = 1</li>"
		f"</ul>"
	)
